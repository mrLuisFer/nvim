...
_G.packer_plugins = {
  ...
  ["barbar.nvim"] = {
    loaded = true,
    path = "/home/mrluisfer/.local/share/nvim/site/pack/packer/start/barbar.nvim",
  ...
  ["cmp-cmdline"] = {
    loaded = true,
    path = "/home/mrluisfer/.local/share/nvim/site/pack/packer/start/cmp-cmdline",
  ...
  ["nightfox.nvim"] = {
    loaded = true,
    path = "/home/mrluisfer/.local/share/nvim/site/pack/packer/start/nightfox.nvim",
  ...
  ["vim-jsx"] = {
    loaded = true,
    path = "/home/mrluisfer/.local/share/nvim/site/pack/packer/start/vim-jsx",
  ...
  ["vim-svelte-plugin"] = {
    loaded = true,
    path = "/home/mrluisfer/.local/share/nvim/site/pack/packer/start/vim-svelte-plugin",
  ...
  ["vim-vsnip"] = {
    loaded = true,
    path = "/home/mrluisfer/.local/share/nvim/site/pack/packer/start/vim-vsnip",
